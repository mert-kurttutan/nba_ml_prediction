...
def run_extract_team_data_entire_year(season: str,  proxy_config: dict):
...
if __name__ == "__main__":
  ...
  for season in season_arr:
    ...
    if f"{TEAM_STAT_DIR}/{season}" in utils.get_subdirs_s3(BUCKET_RAW):
      print(f"Directory {TEAM_STAT_DIR}/{season} is already uploaded to S3")
      continue
